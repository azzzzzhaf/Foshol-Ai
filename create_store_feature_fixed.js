...
// Use double quotes properly inside backticks or single quotes.
...
// Let's avoid the slash issue by using backticks directly without quotes around store.
...
if(!adminHtml.includes('data-tab="store"')) {
    adminHtml = adminHtml.substring(0, sidebarNavEnd) + storeBtnSafe + adminHtml.substring(sidebarNavEnd);
}
